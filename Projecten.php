    ...
    <div class="relative z-10 w-full">
        ...
        <section class="mt-32">
            ...
            <p class="text-xl text-center mt-8 w-3/4 lg:w-1/2 mx-auto">
                Welkom bij mijn projectpagina! Hier vind je een selectie van de projecten waar ik aan heb gewerkt. Bekijk mijn werk en ontdek hoe je zelf kunt bijdragen.
            </p>
        </section>
